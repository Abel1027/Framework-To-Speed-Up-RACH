					...
					if dlRRCChannel != 'None' and dlRRCChannel.split('|')[0].split('=')[1] == TC_RNTIRequester and dlRRCChannel.split('|')[1].split('=')[1] == str(randomValueRequester):
						if resourcesAllocated == 0:
							...
							if totalRegisteredDevices > fixedR:
								registeredDevicesByTimestamp.append(env.now - richedRelaysStartTime)
							registeredDevicesByTimestamp.append(env.now)
							print(env.now, 'us: Registered', totalRegisteredDevices, 'of', totalDev + fixedR, 'Device (' + str(index) + ') -> (Slice Group: ' + str(network_slice) + ')')
							...
							rrcReceived = True
							if totalRegisteredDevices > fixedR:
								totalTimeForRegistration = env.now - richedRelaysStartTime
						break
...
def main(fixedRelays, totalDevices, framework, noClassicRACH, discoverBeforeSIB1, totalNetworkSlices, maxSym, maxSC, blePower, mnPower, getFreqFromGNB, mobility, printLogs, seed):
...
if __name__ == '__main__':
	fixedRelays = 1000
	totalDevices = 1000 # total number of devices that want to get resources from the network
	...
	# for test
	#histogram, logs = main(fixedRelays, totalDevices, framework, noClassicRACH, discoverBeforeSIB1, totalNetworkSlices, maxSym, maxSC, blePower, mnPower, getFreqFromGNB, mobility, printLogs, seed=seed)
	#print(logs)
	#print(histogram)
	...
	for seed in range(10):
		...
		for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
			...
			histogram, logs = main(fixedRelays, totalD, framework=False, noClassicRACH=False, discoverBeforeSIB1=False, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False, seed=seed)
		...
		for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
			...
			histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=False, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False, seed=seed)
		...
		for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
			...
			histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False, seed=seed)
		...
		for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
			...
			histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=False, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=True, mobility=False, printLogs=False, seed=seed)
		...
		for totalD in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
			...
			histogram, logs = main(fixedRelays, totalD, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxSym, maxSC=maxSC, blePower=blePower, mnPower=mnPower, getFreqFromGNB=True, mobility=False, printLogs=False, seed=seed)
		...
		for maxS in [5, 10, 14]:
			for maxSc in [1, 2, 3]:
				...
				histogram, logs = main(fixedRelays, 100, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxS, maxSC=maxSc, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False, seed=seed)
		...
		for maxS in [5, 10, 14]:
			for maxSc in [1, 2, 3]:
				...
				histogram, logs = main(fixedRelays, 1000, framework=True, noClassicRACH=True, discoverBeforeSIB1=True, totalNetworkSlices=totalNetworkSlices, maxSym=maxS, maxSC=maxSc, blePower=blePower, mnPower=mnPower, getFreqFromGNB=False, mobility=False, printLogs=False, seed=seed)
