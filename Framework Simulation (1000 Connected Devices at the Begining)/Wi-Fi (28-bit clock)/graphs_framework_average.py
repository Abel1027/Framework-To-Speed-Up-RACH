...
plt.plot(totalDevices3, totalCollisions24Band3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalCollisionsNetwork3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalCollisions3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalEnergy24Band3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalEnergyNetwork3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalEnergy3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalEnergy3, '-v', label='Framework (before SIB1)')
...
plt.plot(totalDevices3, totalEnergyGNB3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalTimeForRegistration3, '-v', label='RACH + Framework (before SIB1)')
...
plt.plot(totalDevices3, totalTimeForRegistration3, '-v', label='Framework (before SIB1)')
