...
plt.savefig('!graphs_average/energyTOTAL.eps')
plt.show()
...
plt.savefig('!graphs_average/timeTOTAL.eps')
plt.show()
...
plt.savefig('!graphs_average/resources_downlink_uplink_100_devices.eps')
plt.show()
##########
...
plt.savefig('!graphs_average/resources_downlink_uplink_1000_devices.eps')
plt.show()
##########